...
/** \brief  recibirá una lista y una función “pFunc”. se deberán iterar todos los elementos
 de la lista y pasárselos a la función “pFunc” que recibirá el elemento y lo agrega en una nueva lista
 *
 * \param Linkedlist
 * \param elemento
 * \return nueva lista
...
/** \brief crea una nueva lista agregando elementos que devuelve el puntero a funcion segun cumplan o no la condicion especificada
 *
 * \param Linkedlist
 * \param elemento
 * \return nueva lista
